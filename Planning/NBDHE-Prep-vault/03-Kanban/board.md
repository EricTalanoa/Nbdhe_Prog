...
- [ ] Phase 7: deepen question bank — ongoing (batch 2 done: +5 Care Planning/Perio, bank now 45
      in vault; live DB seed still pending for batch 2)
...
- [~] Phase 7: bank depth (7b, ongoing) — batch 1: +5 Local Anesthesia (bank 40, seeded live);
      batch 2: +5 Care Planning/Perio Management (bank 45 in vault, live seed pending)
